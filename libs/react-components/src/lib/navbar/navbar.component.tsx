...
export function Navbar({ logo, redirection, actions, isFixed }: NavbarComponentProps): JSX.Element {
  return (
    <header className={`vtmn-navbar vtmn-shadow-100 ${isFixed ? `vtmn-sticky` : ``}`} data-testid="header">
      <div className="vtmn-navbar_logo">
        <a href={redirection} className="vtmn-flex vtmn-justify-center vtmn-items-center " title="Go back home">
